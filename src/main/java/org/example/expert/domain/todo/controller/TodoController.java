...
public class TodoController {
    ...
    public ResponseEntity<Page<TodoConditionResponse>> getConditionTodo(
            @RequestParam(defaultValue = "1") int page,
            @RequestParam(defaultValue = "10") int size,
        ...
        return ResponseEntity.ok(todoService.getConditionTodo(page, size, title, start, end, nickname));
    }
}
